...
//Adding new attributes (References used: LogDistancePropagationLossModel and RandomPropagationLossModel)
...
double rxc1 = -m_randVariable->GetValue ();
