...
// to display the final positions create a vector
  Vector positionOf (Ptr<Node> n)
 {
...
main (int argc, char *argv[])
{
  ...
  //Add flow monitor to compute throughput
...
1000 / 1000  << " Mbps\n";
  ...
  std::cout << "server: " << positionOf (wifiStaNodes.Get(0)) << "\n";
  std::cout << "client: " << positionOf (wifiStaNodes.Get(nWifi-1)) << std::endl;
  Simulator::Destroy ();
  return 0;
}
